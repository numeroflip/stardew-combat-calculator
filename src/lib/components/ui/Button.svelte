...
<button
	...
	class={cn(
		' pixel-wrap-border relative z-10 flex items-center gap-2 border-[#853605] bg-[#fa9305] px-3 py-0 pb-[2px] pt-[3px] font-stardew text-lg leading-7 text-black hover:brightness-110 md:px-4 md:py-1 md:pt-[6px] md:text-2xl',
		$$props.class
	)}
>
	<slot />
	...
	<div
		class="absolute -bottom-[var(--shadowOffset)] -left-[calc(var(--shadowOffset)_-_4px)] right-0 -z-10 h-[var(--borderWidth)] bg-black/30"
	/>
	<div
		class="absolute -bottom-1 -left-[var(--shadowOffset)] top-[var(--shadowOffset)] -z-10 w-[6px] bg-black/30"
	/>
</button>
